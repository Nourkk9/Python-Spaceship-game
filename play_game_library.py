...
class Game(): 
    def __init__(self,name):
        ...
        self.current_time = 0
        self.interval =60000 # 1 min

        #--to generate two heart (each 1.5min)
        self.current_time_heart = 0
        self.interval_heart =90000 # 1.5 min

        #--to generate an icon to get a new laser (each 2min)
        self.current_time_laser = 0
        self.interval_laser =120000 # 2 min

        #-- new laser expiration time
        self.current_time_new_laser = 0
        self.interval_new_laser =15000 # 15sec
        ...
        self.create_blocks("bad_block",100,SCREEN_HEIGHT)
    ...
    def create_blocks(self,type,size,y_pos):
        if type == "good_block":  
            ...
            for block in range(size):
                block = goodblock_library.Goodblock("images/big-diamond.png",SCREEN_WIDTH,SCREEN_HEIGHT)
                block.rect.x = random.randrange(SCREEN_WIDTH)
                block.rect.y = random.randrange(-300, y_pos)
            ...
            for block in range(size):
                block = goodblock_library.Goodblock("images/add_heart.png",SCREEN_WIDTH,SCREEN_HEIGHT)
                block.rect.x = random.randrange(SCREEN_WIDTH)
                block.rect.y = random.randrange(-300, y_pos)
            ...
            block = goodblock_library.Goodblock("images/new_laser.png",SCREEN_WIDTH,SCREEN_HEIGHT)
            block.rect.x = random.randrange(SCREEN_WIDTH)
            block.rect.y = random.randrange(-300, y_pos)
